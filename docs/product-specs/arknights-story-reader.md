...
- dialogue cards use a portrait-plus-header layout with borderless 2x top-cropped portraits, giving the spoken text the full card width instead of a narrow side-by-side split
