...
- story surfaces: dynamic story backdrops switch behind the content from intersecting background blocks without blur/backdrop-filter effects, while in-flow background cards keep uncropped optimized WebP previews, dialogue cards prioritize body-first reading layouts, and desktop sibling navigation uses compact wrapping badges with matching accent phase tones
