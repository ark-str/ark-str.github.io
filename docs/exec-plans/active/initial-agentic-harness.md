...
Turn an empty repository into a Next.js single-page app with a repository-local harness that can drive one autonomous implementation iteration.
...
- add a Codex iteration entry point
