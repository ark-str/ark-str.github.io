...
- [ ] add the regression-recovery active plan and child issue metadata
- [ ] remove `src/generated/content/stories/**` from the app-side generated contract
- [ ] switch the app to exact-path reads from `public/generated/content/`
- [ ] separate export/verify cache output from the default dev `.next` directory
- [ ] refresh docs and iteration records after verification
