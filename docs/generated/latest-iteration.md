...
- `#29` via merged PR `#30` - download the portrait source cache, normalize story dialogue to `speakerId`, and bundle referenced ASSISTANT portraits into the reader
...
- parser, content, app export, and exported-site smoke all passed through `npm run verify` before merge from branch `codex-speaker-portrait-speakerid-issue-29`
